-- Extend the existing route source of truth; no parallel activity table is introduced.
...
alter table public.route_activities add constraint route_activities_activity_type_check
  check (activity_type in ('Koşu', 'Yürüyüş', 'Doğa Yürüyüşü', 'Trail Koşusu', 'Bisiklet'));
